/**
 * js/auth.js
 * Shared authentication manager — JWT storage, user decoding, sidebar rendering.
...
/** Call on protected pages — redirects to login if no valid token. */
...
/** Store token returned by API and redirect to destination. */
...
/** Inject the sidebar HTML into #sidebar-container and wire up toggle. */
  ...
  const html = `
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div class="sidebar-footer">
        ...
        <button onclick="logout()" class="cyber-btn cyber-btn-ghost cyber-btn-full" style="margin-top:8px;font-size:0.8rem;">
          Log Out
        </button>
      </div>
    </aside>`;
...
/** Show an alert banner inside #alert-container. */
